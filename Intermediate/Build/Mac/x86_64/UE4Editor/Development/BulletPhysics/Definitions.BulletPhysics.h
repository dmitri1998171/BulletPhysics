...
#define UE_PROJECT_NAME BulletPhysics
#define UE_TARGET_NAME BulletPhysicsEditor
#define UE_MODULE_NAME "BulletPhysics"
...
#define BULLETPHYSICS_API DLLEXPORT
